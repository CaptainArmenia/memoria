...
img_name = "17635"
img_path = "D:/Documentos/reconocimiento/FashionProductImagesDataset/139630_329006_bundle_archive/fashion-dataset/images/" + img_name + ".jpg"
...
#    print(layer.name)
gap_layer = model.get_layer('avg_pool')
...
file = open("C:/Users/andyb/PycharmProjects/resnetRopaLowRes/data/mapping.txt")
...
iterate = K.function([model.input], [pooled_grads, last_conv_layer.output[0], gap_layer.output[0]])
pooled_grads_value, conv_layer_output_value, gap_layer_output_value = iterate([x])
